...
$subscription = $getSubscription->fetch();
		...
		<?php
			...
			if(isset($_SESSION['userType'])) {
				if(count($result) == 0) {
					...
					echo '
					<div id="left-form">
						<form method="POST" action="/353_Main_Project/php_scripts/unfreeze.php">
							<input type="hidden" name="currentSubscription" value="'.$subscription['subscription_model_id'].'">
